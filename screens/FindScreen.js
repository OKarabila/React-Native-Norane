      ...
      return (
        ...
        <View style={styles.container} key={kl[f1].idorder}>
          <View style={styles.imgitems} >
              <Text style={{color:'#f40b62',fontSize:20,fontWeight:'700',marginTop:15}}>Client : {item7[i][1]}</Text>
    ...
    <View style={backgroundStyle}>
        <SafeAreaView style={{marginBottom:0,}} >
            <ScrollView refreshControl={
              ...
              <Text style={{color:'#f40b62',fontSize:10,fontWeight:'200',marginTop:5}}></Text>
            </ScrollView>
